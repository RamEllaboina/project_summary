...
const SignupPage: React.FC = () => {
  ...
  const validateReferralCode = async (code: string) => {
    ...
    try {
      await referralApi.validateCode(code)
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {isReferralValid === true && (
                <p className="mt-1 text-sm text-success-600">Valid referral code!</p>
              )}
              {isReferralValid === false && (
                <p className="mt-1 text-sm text-danger-600">Invalid referral code</p>
              )}
            </div>
